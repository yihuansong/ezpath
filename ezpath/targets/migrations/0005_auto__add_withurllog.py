...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WithURLLog'
        db.create_table(u'targets_withurllog', (
        ...
        db.send_create_signal(u'targets', ['WithURLLog'])


    def backwards(self, orm):
        # Deleting model 'WithURLLog'
        db.delete_table(u'targets_withurllog')
    ...
    models = {
        ...
        u'targets.withurllog': {
            'Meta': {'object_name': 'WithURLLog'},
            'content': ('django.db.models.fields.TextField', [], {}),
            'datetime_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'datetime_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
